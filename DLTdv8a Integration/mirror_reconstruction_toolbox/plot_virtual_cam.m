...
NOTE
====
This function is in-progress... right now, only plots the camAxes.
%}
...
quiver3(T_world(1), T_world(2), T_world(3), R_world(1,1), R_world(2,1), R_world(3,1), size, "r", "LineWidth", 4, "HandleVisibility","off");
% text(T_world(1), T_world(2), T_world(3), "X", "FontSize", 14)

% Camera Y-axis orientation plot at the camera center in the world.
quiver3(T_world(1), T_world(2), T_world(3), R_world(1,2), R_world(2,2), R_world(3,2), size, "g", "LineWidth", 4, "HandleVisibility","off");
% text(T_world(1), T_world(2), T_world(3), "Y", "FontSize", 14)

% Camera Z-axis orientation plot at the camera center in the world.
quiver3(T_world(1), T_world(2), T_world(3), R_world(1,3), R_world(2,3), R_world(3,3), size, "b", "LineWidth", 4, "HandleVisibility","off");
