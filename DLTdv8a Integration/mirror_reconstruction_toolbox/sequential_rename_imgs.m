...
if ~input_dir
    ...
    if ~isfolder(input_dir)
        err_msg = sprintf( ...
            ...
            '\nPossible solutions:' ...
            '\n\t(1) Run `extract_calib_vid_imgs.m` before this script' ...
...
while true
    ...
    img_extension = input(['[PROMPT] Enter image extension for calibration frames ' ...
...
img_filepaths = dir(fullfile(directory, ['*' img_extension]));
