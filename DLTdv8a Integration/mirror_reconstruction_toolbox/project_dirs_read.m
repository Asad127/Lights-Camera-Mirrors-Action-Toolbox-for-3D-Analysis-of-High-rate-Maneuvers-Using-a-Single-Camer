...
% absolute directories of projects setup with `setup_project_structure.m`
% in the form: <projectName>_project_dir = absolute_project_dir
...
% this_project. This is how the projects are created in
% `setup_mirror_reconstruction_toolbox.m` as well.
%
% TAKES
% =====
% Nothing. The file is on the toolbox path, so as long as the toolbox is
% included on MATLABL path, this should work without input.
%
% RETURNS
% =======
% projects_file_lines:
