...
if calib_img_or_vid == 'i'
    ...
    for i = 1 : numel(src_filepaths)
        ...
        calib_vid_file = sprintf(default.BCT_CALIB_IMGNAME_FMT, i, src_ext);
        calib_imgs_filepath = fullfile(calib_imgs_dir, calib_vid_file);
        copyfile(src_filepath, calib_imgs_filepath);

        fprintf('[FINISH] Images are ready for BCT calibration at: %s\n', calib_imgs_filepath)
        fprintf('\n...changing CWD to directory with calibration images...\n')
        cd(calib_imgs_filepath);
    end
