...
matrix_to_write = cell(num_rows, entries_per_row);
...
for f = 1 : num_valid_frames
    ...
    matrix_to_write(f+1, :) = file_row;
end

writecell(matrix_to_write, save_filepath, 'Delimiter', ',')
